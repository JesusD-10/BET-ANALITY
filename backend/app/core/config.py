...
class Settings(BaseSettings):
    ...
    api_football_timeout_seconds: int = 15
    football_data_api_token: str = ""
    football_data_base_url: str = "https://api.football-data.org/v4"
    football_data_timeout_seconds: int = 15

    model_config = SettingsConfigDict(
        env_file=(PROJECT_ROOT / ".env.example", PROJECT_ROOT / ".env", PROJECT_ROOT / ".env.development.local"),
        extra="ignore",
    )
